চল ভাই, তোকে একদম পরিষ্কার করে Node.js HTTP module এর উপরে সুন্দরভাবে সাজানো বাংলা-English মিশ্র .md ফর্ম্যাটে নোট বানিয়ে দিই — যেন মুখস্থ না করে বুজে ফেলা যায়।
